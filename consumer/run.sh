...
export CP=""
export CP="${CP}:/Users/buesing/workspaces/kineticedge/kafka-java-poc/consumer/build/classes/java/main"
export CP="${CP}:/Users/buesing/workspaces/kineticedge/kafka-java-poc/consumer/build/resources/main"
...
java -cp ${CP} io.kineticedge.poc.consumer.Main "$@"
